...
- Déploiement    : `main` déploie `ethone-next/dist` via `.github/workflows/deploy-pages.yml`. Les scripts `scripts/verify-deployment.mjs` et `scripts/verify-security-headers.mjs` vérifient le déploiement.
