...
const translations: Record<SupportedLanguage, TranslationDictionary> = {
  fr: {
    ...
    sanction_dm_footer: 'ETHONE Modération',
    ...
    music_panel_idle_desc: '**Aucune musique en cours de lecture.**\n\nUtilisez `/play <titre/lien>` ou le **Music Center ETHONE** pour lancer un morceau.',
    music_panel_field_voice_channel: '🔊 Salon Vocal',
    music_panel_field_queue: '📜 File d\'attente',
    music_panel_disconnected: 'Déconnecté',
    music_panel_footer_idle: 'ETHONE Musique • Audio Engine',
    music_panel_footer_active: 'ETHONE Musique • Contrôlez la musique en direct',
    ...
    poll_live_results_footer: 'Total participants : {count} • ETHONE Sondages',
    ...
    automod_status_title: '🤖 AutoMod — {guildName}',
    ...
    automod_alert_title: '🤖 AutoMod — {rule}',
    ...
    events_panel_footer: 'ETHONE Événements • ID: {id}',
    ...
    antiraid_status_title: '🛡️ Anti-Raid — {guildName}',
    ...
    antiraid_status_footer: 'ETHONE Anti-Raid • Dashboard Web disponible',
    ...
    antiraid_alert_footer: 'Incident ID : {incidentId} • ETHONE Anti-Raid',
  ...
  en: {
    ...
    antiraid_field_mentions: '🔔 Mentions (60s)',
    antiraid_mentions_value: '{count} mentions',
    antiraid_status_footer: 'ETHONE Anti-Raid • Web Dashboard available',
  ...
  es: {
    ...
    music_panel_title: '🎵 ETHONE Music Player',
    music_panel_idle_desc: '**No hay música reproduciéndose actualmente.**\n\nUsa `/play <título/enlace>` o el **Music Center ETHONE** para poner una canción.',
    music_panel_field_voice_channel: '🔊 Canal de Voz',
    music_panel_field_queue: '📜 Cola',
    music_panel_disconnected: 'Desconectado',
    music_panel_footer_idle: 'ETHONE Musique • Motor de Audio',
    music_panel_footer_active: 'ETHONE Musique • Controla la música en vivo',
    ...
    poll_live_results_footer: 'Total de participantes: {count} • ETHONE Sondages',
    ...
    antiraid_status_footer: 'ETHONE Anti-Raid • Panel Web disponible',
    ...
    antiraid_alert_actions_none: '✓ `LOG_EVENT`',
    antiraid_alert_footer: 'ID de Incidente: {incidentId} • ETHONE Anti-Raid',
  ...
  de: {
    ...
    poll_live_results_footer: 'Teilnehmer gesamt: {count} • ETHONE Sondages',
    ...
    antiraid_status_footer: 'ETHONE Anti-Raid • Web-Dashboard verfügbar',
    ...
    antiraid_alert_actions_none: '✓ `LOG_EVENT`',
    antiraid_alert_footer: 'Vorfall-ID: {incidentId} • ETHONE Anti-Raid',
