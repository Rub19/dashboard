...
ok(first.includes('2026-09-25-disable-leveling-everywhere') && first.includes('2026-09-25-automod-everything-off'), 'les migrations (XP coupé, AutoMod coupé) sont appliquées au premier démarrage');
