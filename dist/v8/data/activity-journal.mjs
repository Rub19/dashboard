const ACTION_EVENTS = Object.freeze({
  "v8.notes.new": { source: "ethone", category: "productivity", icon: "notebook-pen", title: "Nouvelle note", description: "Une note a ete creee dans ETHONE." },
  ...
  "v8.tasks.create": { source: "ethone", category: "productivity", icon: "circle-check-big", title: "Tache ajoutee", description: "Une nouvelle priorite rejoint votre liste." },
  "v8.calendar.create": { source: "calendar", category: "work", icon: "calendar-plus", title: "Evenement ajoute", description: "Le planning local a ete mis a jour." },
  ...
  "v8.sync.refresh": { source: "ethone", category: "system", icon: "refresh-cw", title: "Synchronisation verifiee", description: "Les donnees locales ont ete controlees." },
  "v8.theme.toggle": { source: "ethone", category: "system", icon: "palette", title: "Theme modifie", description: "L'apparence du systeme a ete adaptee." },
  "v8.appearance.cycle": { source: "ethone", category: "system", icon: "palette", title: "Accent modifie", description: "La couleur active a ete adaptee." }
});
...
const ROUTE_EVENTS = Object.freeze({
  ...
  tasks: { category: "productivity", icon: "circle-check-big", title: "Taches ouvertes", description: "Votre liste de priorites est au premier plan." },
  ...
  connections: { category: "system", icon: "plug", title: "Connections ouvertes", description: "Le catalogue des integrations est au premier plan." },
  ...
  brain: { category: "brain", icon: "brain", title: "Brain ouvert", description: "Votre synthese contextuelle est au premier plan." },
  settings: { category: "system", icon: "settings-2", title: "Reglages ouverts", description: "Les preferences du systeme sont au premier plan." }
});
...
function derivedEntries(snapshot, nowIso) {
  ...
  (snapshot.tasks || []).slice(0, 10).forEach((task) => entries.push({
    ...
    title: task.title,
    description: task.done ? "Tache terminee." : "Tache encore ouverte.",
  ...
  (snapshot.events || []).slice(0, 8).forEach((event) => entries.push({
    ...
    icon: "calendar-days",
    title: event.title,
    description: "Evenement present dans votre planning.",
