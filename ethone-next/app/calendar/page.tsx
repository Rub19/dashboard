...
export default function CalendarPage() {
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col gap-4 overflow-hidden p-0 sm:p-0">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white">{i18n("calendarTitle", "Calendrier")}</h1>
          <p className="text-xs text-zinc-400">{i18n("calendarBillingDescription", "Échéances et factures")}</p>
        </div>
      </div>
