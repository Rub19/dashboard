      ...
      <div className="shrink-0 border-b border-white/10 bg-[var(--bg-surface-elevated)]/80 backdrop-blur-md px-4 sm:px-6 py-3.5 flex flex-wrap items-center justify-between gap-3 z-20">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-base font-semibold tracking-tight text-white">AFK</h1>
              <p className="text-xs text-white/40">Statut absent + notification sur mention</p>
            </div>
          </div>
        </div>
          ...
          <>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] overflow-hidden">
              ...
              {!overview || overview.members.length === 0 ? (
                <p className="px-4 py-8 text-center text-sm text-zinc-500">Personne n&apos;est AFK.</p>
              ) : (
                    ...
                    <div key={m.userId} className="flex items-center gap-3 p-4">
                      <div className="min-w-0 flex-1">
                        <p className="text-sm font-semibold text-white">
                          <code className="text-zinc-400">{m.userId}</code>
                          <span className="ml-2 text-[11px] font-normal text-zinc-500">depuis {since(m.since)} · {m.mentionCount} mentions</span>
                        </p>
