...
export default function UserModerationProfileClient() {
  ...
  }, [selectedGuild, botGuildIds, targetUserId]);
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-300/80">
                  Pour inspecter le dossier disciplinaire et exécuter des sanctions sur <span className="font-semibold">{selectedGuild.name}</span>, invitez le bot.
                </p>
              </div>
            </div>
            <a
