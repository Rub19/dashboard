...
const PRESETS: Array<{ id: string; emoji: string; label: string; text: string; ids: string[] | "all" }> = [
  { id: "minimal", emoji: "⚡", label: "Minimal", text: "Modération, musique, rappels et tags.", ids: CORE },
  {
    ...
    ids: [...CORE, "welcome", "roles", "leveling", "economy", "suggestions", "polls", "giveaways", "events", "forms", "starboard", "highlights", "birthdays", "voice", "tickets", "invites", "afk", "serverstats", "sticky", "commands"],
  },
...
const GROUPS: Array<{ title: string; ids: string[] }> = [
  ...
  { title: "Communauté & animation", ids: ["welcome", "roles", "leveling", "economy", "suggestions", "polls", "giveaways", "events", "forms", "starboard", "highlights", "birthdays", "music", "voice", "commands", "tags", "reminders", "sticky", "afk", "serverstats", "ai"] },
];
