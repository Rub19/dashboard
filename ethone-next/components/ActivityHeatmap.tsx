      ...
      <AnimatePresence>
        {tooltip && (
          <motion.div
            ...
            className="pointer-events-none fixed z-[var(--z-dock)] -translate-x-1/2 -translate-y-full rounded-lg border border-[var(--panel-border)] bg-[var(--panel-bg)]/90 px-2.5 py-1.5 text-[11px] text-[var(--text-primary)] shadow-xl backdrop-blur-xl"
