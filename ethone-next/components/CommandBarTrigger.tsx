...
export default function CommandBarTrigger(props: ButtonHTMLAttributes<HTMLButtonElement>) {
  ...
  return (
    ...
    >
      ...
      <kbd className="pointer-events-none hidden md:inline-flex items-center gap-0.5 rounded border border-white/10 bg-white/[0.08] px-1.5 py-0.5 text-[11px] font-mono text-zinc-300 md:ml-2">
