...
export default function CommandBarTrigger(props: ButtonHTMLAttributes<HTMLButtonElement>) {
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none hidden 2xl:inline 2xl:ml-2 text-sm">{i18n("commands")}</span>
      <kbd className="pointer-events-none hidden 2xl:inline-flex items-center gap-0.5 rounded border border-[var(--text-primary)]/10 bg-[var(--text-primary)]/[0.08] px-1.5 py-0.5 text-[11px] font-mono text-[var(--text-primary)] 2xl:ml-2">
