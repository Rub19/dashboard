...
export default function Dock() {
  ...
  return (
    <div
      className="v8-floating-dock fixed bottom-6 inset-x-0 z-50 hidden md:flex pointer-events-none justify-center bg-transparent p-0 m-0 border-none shadow-none outline-none"
    >
      {launcherOpen && (
