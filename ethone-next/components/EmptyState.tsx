  ...
  return (
    ...
    >
      <div className="v8-empty-state__visual relative" aria-hidden="true">
        <span className="v8-empty-state__frame v8-empty-state__frame--back absolute inset-0 rounded-2xl bg-[var(--surface-raised)] opacity-60" />
        <span className="v8-empty-state__frame v8-empty-state__frame--front relative z-10 flex items-center justify-center rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4 shadow-sm">
