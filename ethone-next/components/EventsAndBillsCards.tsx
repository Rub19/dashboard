...
export function EventsCard({ date, items, onAdd }: EventsCardProps) {
  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl v8-panel p-5">
      {/* Header */}
...
export function InvoicesCard({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl v8-panel p-5">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Receipt className="h-4 w-4 text-[var(--accent-primary)]" />
