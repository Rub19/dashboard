...
import { MessageSideContext } from "@/components/MessageSideContext";
...
function bubbleContentClass(
  ...
  return cn(
    ...
    interactive &&
      "cursor-pointer text-left outline-none transition-[background-color,color,transform] duration-150 hover:brightness-[0.98] focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] active:scale-[0.99]",
  );
}
...
function bubbleSurfaceClass(
  ...
  return cn(
    ...
    variant === "danger" && "bg-[var(--danger)]/10",
  );
}
