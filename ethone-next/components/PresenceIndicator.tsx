  ...
  return (
    ...
    >
      ...
      {p.badge !== undefined && p.badge > 0 ? (
        <span className="absolute -right-1 -top-1 flex h-3.5 min-w-[0.875rem] items-center justify-center rounded-lg bg-[var(--accent)] px-1 text-[8px] font-bold text-[var(--text-primary)]">
