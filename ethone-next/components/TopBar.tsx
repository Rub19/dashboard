...
function TopBar() {
  ...
  return (
    <header
      data-v8-topbar
      className="pointer-events-none relative z-40 shrink-0 select-none rounded-r-2xl rounded-l-none border border-[var(--panel-border)] bg-[var(--panel-bg)] px-4 pt-safe backdrop-blur-[var(--panel-blur)]"
    >
