    ...
    <AnimatePresence>
      {hasUpdate && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 z-[9999] w-[calc(100%-2rem)] max-w-xl -translate-x-1/2 select-none rounded-2xl border border-[--accent-primary] bg-zinc-950/90 p-4 shadow-[0_12px_48px_rgba(0,0,0,0.7),0_0_24px_var(--glow-color)] backdrop-blur-2xl"
          role="status"
          aria-live="polite"
        >
          <div className="flex items-center gap-3.5">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-[--accent-primary] bg-[--accent-primary] text-[--accent-primary] shadow-[0_0_16px_var(--glow-color)]">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                {versionLabel && (
                  <span className="rounded-md border border-[--accent-primary] bg-[--accent-primary] px-1.5 py-0.5 text-[10px] font-mono font-semibold text-[--accent-primary]">
                    {versionLabel}
                  </span>
                )}
              </div>
