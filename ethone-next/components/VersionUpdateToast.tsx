    ...
    <AnimatePresence>
      {hasUpdate && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 z-[9999] w-[calc(100%-2rem)] max-w-xl -translate-x-1/2 select-none rounded-2xl border border-[var(--panel-border)] bg-[var(--background)]/95 p-4 shadow-[0_12px_48px_rgba(0,0,0,0.7),0_0_24px_var(--glow-color)] backdrop-blur-2xl"
          role="status"
          aria-live="polite"
        >
