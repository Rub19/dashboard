...
export function weatherAmbience(code?: number, isDay?: boolean): { gradient: string; border: string; glow: string } {
  ...
  if (isRainyOrStormy) {
    return {
      gradient: "bg-gradient-to-br from-cyan-500/10 via-zinc-950/80 to-zinc-950",
...
export function weatherIconColor(code?: number, isDay?: boolean): string {
  ...
  if ((code !== undefined && code >= 71 && code <= 77) || (code !== undefined && code >= 85 && code <= 86)) return "text-cyan-200";
      ...
      <div className="relative z-10 flex h-full min-h-0 flex-col">
        ...
        {!compact && (
          <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            {pressure !== undefined && (
              <div className="flex items-center gap-1.5 text-xs text-zinc-400">
                <Icon name="gauge" className="h-3.5 w-3.5 text-emerald-400" />
                <span>
