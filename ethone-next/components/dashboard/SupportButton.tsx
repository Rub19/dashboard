...
const SupportButton = memo(function SupportButton({
  ...
  return (
    <a
      ...
      className={cn(
        "inline-flex items-center gap-2 rounded-[var(--inset-radius)] border border-[var(--text-primary)]/[0.06] bg-[var(--text-primary)]/[0.03] px-3 py-2 text-xs font-medium text-[var(--text-muted)] backdrop-blur-md transition-all duration-200",
