                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className={cn("w-2 h-2 rounded-full", cfg.dot, sub.status === "operational" && "animate-pulse ring-2 ring-emerald-500/20")} />
                    </div>
          ...
          <Card variant="default" padding="none" className="p-5 sm:p-6 space-y-6 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-zinc-800">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold flex items-center gap-2 transition-all shadow-md shadow-emerald-600/20 disabled:opacity-50 cursor-pointer"
              >
