...
export default function StatusBar() {
  ...
  return (
    <footer
      data-v8-status-bar
      data-status-bar
      className="fixed bottom-0 left-0 z-30 h-[calc(2rem+env(safe-area-inset-bottom))] pb-[env(safe-area-inset-bottom)] w-full select-none border-t border-[var(--panel-border)]/[0.15] bg-[var(--panel-bg)]/30 px-4 text-xs text-[var(--text-primary)] backdrop-blur-[var(--panel-blur)]"
    >
