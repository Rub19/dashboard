    ...
    >
      <div className="space-y-5 p-1">
        ...
        <div className="flex items-center gap-3 border-b border-[var(--panel-border)]/60 pb-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[var(--panel-radius)] border border-purple-500/40 bg-purple-950/40 text-purple-300 shadow-md">
        ...
        {/* Brain Score Pill */}
        <div className="flex items-center justify-between rounded-[var(--panel-radius)] border border-purple-500/30 bg-purple-950/20 p-4">
          <div>
        ...
        {/* Privacy Note */}
        <div className="rounded-[var(--inset-radius)] border border-sky-500/20 bg-sky-950/10 p-3 text-[11px] text-sky-200/80 leading-relaxed flex items-center gap-2">
        ...
        <div className="pt-3 border-t border-[var(--panel-border)]/60 flex items-center justify-between gap-3 text-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-[var(--inset-radius)] border border-[var(--panel-border)] bg-[var(--surface-raised)] hover:bg-[var(--surface-hover)] px-3 py-1.5 font-semibold text-[var(--text-muted)] hover:text-white transition-colors cursor-pointer"
            >
