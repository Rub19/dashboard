    ...
    <div className="space-y-6">
      ...
      <div className="rounded-[var(--panel-radius)] border border-[var(--panel-border)]/80 bg-[var(--surface-raised)]/60 p-5 sm:p-6 backdrop-blur-md space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {/* Email Card */}
          <div className="rounded-[var(--panel-radius)] border border-[var(--panel-border)]/60 bg-[var(--surface-raised)]/40 p-3.5 space-y-1">
        ...
        <div className="pt-2 flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 rounded-[var(--inset-radius)] border border-[var(--panel-border)] bg-[var(--surface-raised)] hover:bg-[var(--surface-hover)] px-3.5 py-2 text-xs font-semibold text-[var(--text-primary)] transition-colors cursor-pointer"
          >
      ...
      <div className="rounded-[var(--panel-radius)] border border-[var(--panel-border)]/80 bg-[var(--surface-raised)]/60 p-5 sm:p-6 backdrop-blur-md space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
          {integrations.map((integ) => (
            <div
              key={integ.id}
              className="flex items-center justify-between rounded-[var(--panel-radius)] border border-[var(--panel-border)]/60 bg-[var(--surface-raised)]/40 p-3"
            >
      ...
      <div className="rounded-[var(--panel-radius)] border border-[var(--panel-border)]/80 bg-[var(--surface-raised)]/60 p-5 sm:p-6 backdrop-blur-md space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 rounded-[var(--panel-radius)] border border-[var(--panel-border)] bg-[var(--surface-raised)] hover:bg-[var(--surface-hover)] px-4 py-3 text-xs font-bold text-[var(--text-primary)] shadow-xs transition-colors cursor-pointer"
          >
            <Download className="h-4 w-4 text-emerald-400" />
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 rounded-[var(--panel-radius)] border border-rose-500/30 bg-rose-950/20 hover:bg-rose-950/40 px-4 py-3 text-xs font-bold text-rose-300 transition-colors cursor-pointer"
          >
      ...
      >
        <div className="space-y-4 p-1">
          <div className="flex items-center gap-3 border-b border-[var(--panel-border)]/60 pb-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-[var(--inset-radius)] bg-rose-950/50 border border-rose-500/30 text-rose-400">
