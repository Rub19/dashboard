...
export default function SettingsContent({
          ...
          <div className="rounded-2xl border border-[var(--panel-border)] bg-[var(--panel-bg)] p-5 flex flex-col gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)]">Version 1.12.33 (Turbopack / Next.js 16.3.3)</p>
              </div>
            </div>
  ...
  useEffect(() => {
    ...
    if (previousQueryRef.current.trim() === form.query.trim()) {
      return;
    }
    previousQueryRef.current = form.query;
        ...
        return (
          <div
            ...
            ref={(el) => {
              ...
              registerCategoryRef?.(category.id, el);
            }}
