...
const VARIANTS: Record<BadgeVariant, string> = {
  ...
  info: "border-[var(--panel-border)] bg-[var(--surface-raised)] text-[var(--text-muted)]",
  ...
  online: "border-[var(--accent-primary)]/25 bg-[var(--accent-primary)]/12 text-[var(--accent-primary)]",
  ...
  synced: "border-[var(--accent-primary)]/25 bg-[var(--accent-primary)]/12 text-[var(--accent-primary)]",
  connected: "border-[var(--accent-primary)]/30 bg-[var(--accent-primary)]/10 text-[var(--accent-primary)]",
  ...
  brain: "border-[var(--accent-primary)]/25 bg-[var(--accent-primary)]/12 text-[var(--accent-primary)]",
};
