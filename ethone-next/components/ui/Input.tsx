...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const baseWrapper =
      "group/input relative flex w-full min-w-0 items-center gap-4 rounded-xl border border-[var(--border-subtle)] bg-[var(--surface)] px-4 text-sm text-[var(--text-primary)] outline-none backdrop-blur-md transition-[color,background-color,border-color,box-shadow] duration-200 ease-out";
