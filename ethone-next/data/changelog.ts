...
const v330_fr: ChangelogEntry = {
  version: "v1.7.49",
  date: "2026-08-22",
  title: "Correction superposition topbar/sidebar et double horloge",
  items: [
    ...
    "Version affichée en bas à droite : v1.7.49.",
  ],
};
...
const v330_en: ChangelogEntry = {
  ...
  items: [
    ...
    "Version badge bottom-right: v1.7.49.",
  ],
};
...
const v330_es: ChangelogEntry = {
  ...
  items: [
    ...
    "Versión mostrada abajo a la derecha: v1.7.49.",
  ],
};
