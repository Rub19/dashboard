...
const v178_fr: ChangelogEntry = {
  ...
  items: [
    ...
    "Dock : fond légèrement plus sombre (80%) et remonté (bottom-10).",
...
const v178_en: ChangelogEntry = {
  ...
  items: [
    ...
    "Dock: slightly darker background (80%) and raised higher (bottom-10).",
...
const v178_es: ChangelogEntry = {
  ...
  items: [
    ...
    "Dock: fondo ligeramente más oscuro (80%) y elevado (bottom-10).",
...
const v178_de: ChangelogEntry = {
  ...
  items: [
    ...
    "Dock: leicht dunklerer Hintergrund (80%) und höher positioniert (bottom-10).",
