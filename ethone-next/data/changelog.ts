...
const CHANGELOG_BY_LANG_DATA: Record<string, ChangelogEntry[]> = {
  "fr": [
    {
      "version": "v1.8.18",
      "date": "24 août 2026",
      "title": "Normalisation du changelog (SemVer, dates, version)",
      "items": [
  ...
  "en": [
    {
      "version": "v1.8.18",
      "date": "24 août 2026",
      "title": "Changelog normalization (SemVer, dates, version)",
      "items": [
        "Replaced v322–v328 tags with official, consistent SemVer versions.",
        "Dates standardized to French format: \"24 août 2026\".",
        "Strict descending date sort in the Release Notes modal.",
        "Synchronized VERSION_LABEL, package.json and public/version.json to v1.8.18.",
        "Automatic version bump rule for every future delivery."
      ]
    },
    {
      "version": "v1.8.17",
  ...
  "es": [
    {
      "version": "v1.8.18",
      "date": "24 août 2026",
      "title": "Normalización del changelog (SemVer, fechas, versión)",
      "items": [
        "Tags v322–v328 reemplazados por versiones SemVer oficiales y coherentes.",
        "Fechas estandarizadas en formato francés: \"24 août 2026\".",
        "Orden estricto descendente por fecha en el modal de Notas de versión.",
        "VERSION_LABEL, package.json y public/version.json sincronizados a v1.8.18.",
        "Regla de incremento automático de versión en cada entrega futura."
      ]
    },
    {
      "version": "v1.8.17",
  ...
  "de": [
    {
      "version": "v1.8.18",
      "date": "24 août 2026",
      "title": "Changelog-Normalisierung (SemVer, Daten, Version)",
      "items": [
        "v322–v328-Tags durch offizielle, konsistente SemVer-Versionen ersetzt.",
        "Daten im französischen Format standardisiert: \"24 août 2026\".",
        "Strikte absteigende Sortierung nach Datum im Versionshinweis-Modal.",
        "VERSION_LABEL, package.json und public/version.json auf v1.8.18 synchronisiert.",
        "Automatische Versionserhöhung bei jeder künftigen Auslieferung."
      ]
    },
    {
      "version": "v1.8.17",
...
export const CHANGELOG = CHANGELOG_BY_LANG_DATA.fr;
export const CHANGELOG_BY_LANG: Record<string, ChangelogEntry[]> = CHANGELOG_BY_LANG_DATA;
