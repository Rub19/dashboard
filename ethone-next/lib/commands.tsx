...
export function useCommandItems(setOpen: (v: boolean) => void): CommandItem[] {
  ...
  return useMemo(() => {
    const base: CommandItem[] = [
      ...
      { id: "nav-profile", label: "Mon Profil & Personnalisation 2.0", subtitle: "Gérer mon identité, avatar, statut et Brain", category: "Profil", icon: <Icon name="user" />, keywords: ["profile", "profil", "avatar", "compte", "moi", "bio", "personnalisation"], action: () => navigate("/profile/") },
      { id: "profile-status", label: "Profil : Changer de statut de présence", subtitle: "En ligne, Focus, Gaming, Occupé...", category: "Profil", icon: <Icon name="smile" />, keywords: ["status", "statut", "presence", "focus", "gaming", "dnd"], action: () => navigate("/profile/") },
      { id: "profile-personalization", label: "Profil : Gérer la personnalisation & Brain", subtitle: "Centres d'intérêt, densité et confidentialité", category: "Profil", icon: <Icon name="sparkles" />, keywords: ["personalization", "interets", "brain", "preferences", "privacy"], action: () => navigate("/profile/") },
      ...
      { id: "discord-bot-dashboard", label: "Dashboard Bot Discord 2.0", subtitle: "Gestion de serveurs, modération, anti-raid, vocaux et tickets", category: "Intégrations", icon: <Icon name="shield" />, requiresOnline: true, keywords: ["discord", "bot", "serveur", "moderation", "anti-raid", "voice", "tickets", "events"], action: () => navigate("/discord") },
