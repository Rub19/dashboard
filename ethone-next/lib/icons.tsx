...
const MAP: Record<string, Partial<Record<IconPack, string>>> = {
  ...
  gamepad: { lucide: "gamepad-2", phosphor: "gamepad", tabler: "device-gamepad", heroicons: "device-phone-mobile", radix: "magic-wand" },
  ...
  "alert-triangle": { lucide: "triangle-alert", phosphor: "warning", tabler: "alert-triangle", heroicons: "exclamation-triangle", radix: "triangle-alert" },
  "triangle-alert": { lucide: "triangle-alert", phosphor: "warning", tabler: "alert-triangle", heroicons: "exclamation-triangle", radix: "triangle-alert" },
  ...
  "cloud-rain": { lucide: "cloud-rain", phosphor: "cloud-rain", tabler: "cloud-rain", heroicons: "cloud", radix: "cloud" },
  cloudSnow: { lucide: "cloud-snow", phosphor: "cloud-snow", tabler: "cloud-snow", heroicons: "cloud", radix: "cloud" },
  "cloud-snow": { lucide: "cloud-snow", phosphor: "cloud-snow", tabler: "cloud-snow", heroicons: "cloud", radix: "cloud" },
  ...
  "cloud-lightning": { lucide: "cloud-lightning", phosphor: "cloud-lightning", tabler: "cloud-lightning", heroicons: "bolt", radix: "lightning-bolt" },
  cloudFog: { lucide: "cloud-fog", phosphor: "cloud-fog", tabler: "cloud-fog", heroicons: "cloud", radix: "cloud" },
  "cloud-fog": { lucide: "cloud-fog", phosphor: "cloud-fog", tabler: "cloud-fog", heroicons: "cloud", radix: "cloud" },
  ...
  "list-collapse": { lucide: "list-collapse", phosphor: "list-bullets", tabler: "list", heroicons: "list-bullet", radix: "list-bullet" },
  "list-plus": { lucide: "list-plus", phosphor: "list-plus", tabler: "list", heroicons: "plus", radix: "plus" },
  "list-todo": { lucide: "list-todo", phosphor: "check-square", tabler: "list-check", heroicons: "check-circle", radix: "check" },
  ...
  "calendar-check-2": { lucide: "calendar-check-2", phosphor: "calendar-check", tabler: "calendar-check", heroicons: "calendar-days", radix: "calendar" },
  "calendar-clock": { lucide: "calendar-clock", phosphor: "calendar", tabler: "calendar-time", heroicons: "calendar-days", radix: "calendar" },
  ...
  accessibility: { lucide: "accessibility", phosphor: "wheelchair", tabler: "accessible", heroicons: "sparkles", radix: "component-1" },
  "battery-charging": { lucide: "battery-charging", phosphor: "battery-charging", tabler: "battery-charging", heroicons: "bolt", radix: "lightning-bolt" },
  "briefcase-business": { lucide: "briefcase", phosphor: "briefcase", tabler: "briefcase", heroicons: "briefcase", radix: "archive" },
  download: { lucide: "download", phosphor: "download-simple", tabler: "download", heroicons: "arrow-down-tray", radix: "download" },
  upload: { lucide: "upload", phosphor: "upload-simple", tabler: "upload", heroicons: "arrow-up-tray", radix: "upload" },
  "upload-cloud": { lucide: "upload-cloud", phosphor: "cloud-arrow-up", tabler: "cloud-upload", heroicons: "arrow-up-tray", radix: "upload" },
  keyboard: { lucide: "keyboard", phosphor: "keyboard", tabler: "keyboard", heroicons: "command-line", radix: "code" },
  languages: { lucide: "languages", phosphor: "translate", tabler: "language", heroicons: "language", radix: "globe" },
  terminal: { lucide: "terminal", phosphor: "terminal-window", tabler: "terminal-2", heroicons: "command-line", radix: "code" },
  "wand-sparkles": { lucide: "sparkles", phosphor: "sparkle", tabler: "wand", heroicons: "sparkles", radix: "magic-wand" },
  waveform: { lucide: "waveform", phosphor: "waveform", tabler: "wave-sine", heroicons: "speaker-wave", radix: "speaker-loud" },
  ...
  sidebar: { lucide: "panel-left", phosphor: "sidebar", tabler: "layout-sidebar", heroicons: "bars-3-bottom-left", radix: "panel-left" },
  "sidebar-simple": { lucide: "panel-left-close", phosphor: "sidebar-simple", tabler: "layout-sidebar-left-collapse", heroicons: "bars-3-bottom-left", radix: "panel-left-minimized" },
  "sidebar-close": { lucide: "panel-left-close", phosphor: "sidebar-simple", tabler: "layout-sidebar-left-collapse", heroicons: "bars-3-bottom-left", radix: "panel-left-minimized" },
  "sidebar-open": { lucide: "panel-left-open", phosphor: "sidebar", tabler: "layout-sidebar-left-expand", heroicons: "bars-3-bottom-left", radix: "panel-left" },
  "panel-left": { lucide: "panel-left", phosphor: "sidebar", tabler: "layout-sidebar", heroicons: "bars-3-bottom-left", radix: "panel-left" },
  "panel-left-close": { lucide: "panel-left-close", phosphor: "sidebar-simple", tabler: "layout-sidebar-left-collapse", heroicons: "bars-3-bottom-left", radix: "panel-left-minimized" },
  "panel-left-open": { lucide: "panel-left-open", phosphor: "sidebar", tabler: "layout-sidebar-left-expand", heroicons: "bars-3-bottom-left", radix: "panel-left" },
  "corners-out": { lucide: "maximize-2", phosphor: "arrows-out", tabler: "maximize", heroicons: "arrows-pointing-out", radix: "zoom-in" },
  "corners-in": { lucide: "minimize-2", phosphor: "arrows-in", tabler: "minimize", heroicons: "arrows-pointing-in", radix: "minimize" },
  "speaker-simple-slash": { lucide: "volume-x", phosphor: "speaker-simple-slash", tabler: "volume-off", heroicons: "speaker-x-mark", radix: "speaker-off" },
  "speaker-simple-high": { lucide: "volume-2", phosphor: "speaker-simple-high", tabler: "volume-2", heroicons: "speaker-wave", radix: "speaker-loud" },
  "speaker-slash": { lucide: "volume-x", phosphor: "speaker-slash", tabler: "volume-off", heroicons: "speaker-x-mark", radix: "speaker-off" },
  "floppy-disk": { lucide: "save", phosphor: "floppy-disk", tabler: "device-floppy", heroicons: "archive-box-arrow-down", radix: "file-text" },
  "paper-plane-tilt": { lucide: "send", phosphor: "paper-plane-tilt", tabler: "send", heroicons: "paper-airplane", radix: "paper-plane" },
  "chat-circle": { lucide: "message-circle", phosphor: "chat-circle", tabler: "message-circle", heroicons: "chat-bubble-oval-left", radix: "chat-bubble" },
  refresh: { lucide: "refresh-cw", phosphor: "arrows-clockwise", tabler: "refresh", heroicons: "arrow-path", radix: "reload" },
  drop: { lucide: "droplets", phosphor: "drop", tabler: "droplet", heroicons: "beaker", radix: "drop" },
  lightning: { lucide: "zap", phosphor: "lightning", tabler: "bolt", heroicons: "bolt", radix: "lightning-bolt" },
  "music-notes": { lucide: "music", phosphor: "music-notes", tabler: "music", heroicons: "musical-note", radix: "track-next" },
  habits: { lucide: "target", phosphor: "target", tabler: "target", heroicons: "check-circle", radix: "target" },
  admin: { lucide: "line-chart", phosphor: "chart-bar", tabler: "chart-bar", heroicons: "chart-bar", radix: "bar-chart" },
  microphone: { lucide: "mic", phosphor: "microphone", tabler: "microphone", heroicons: "microphone", radix: "speaker-loud" },
  "microphone-slash": { lucide: "mic-off", phosphor: "microphone-slash", tabler: "microphone-off", heroicons: "speaker-x-mark", radix: "speaker-off" },
};
