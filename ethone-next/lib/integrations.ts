...
export const INTEGRATIONS: Integration[] = [
  ...
  { id: "tracker", name: "Tracker.gg", category: "gaming", status: "restricted", description: "descTracker", icon: "chart-no-axes-combined", liveSignal: "Classement mis a jour" },
...
export const OFFICIAL_HOME: Record<string, string> = {
  ...
  tracker: "https://tracker.gg/developers",
