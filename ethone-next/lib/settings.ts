...
/** Couleurs de statut fixes (définies dans globals.css) : elles ne dépendent pas de la couleur d'accent du thème. */
...
> = {
  online: {
    ...
    icon: "circle",
    dot: "bg-[var(--status-online)]",
    text: "text-[var(--status-online)]",
    bg: "bg-[var(--status-online)]/10",
    ring: "ring-[var(--status-online)]/40",
    presence: "online",
  },
  focus: {
    labelKey: "statusFocus",
    icon: "target",
    dot: "bg-[var(--status-focus)]",
    text: "text-[var(--status-focus)]",
    bg: "bg-[var(--status-focus)]/10",
    ring: "ring-[var(--status-focus)]/40",
    presence: "online",
  },
  busy: {
    labelKey: "statusBusy",
    ...
    text: "text-[var(--status-busy)]",
    bg: "bg-[var(--status-busy)]/10",
    ring: "ring-[var(--status-busy)]/40",
    presence: "dnd",
  },
  away: {
    labelKey: "statusAway",
    icon: "clock",
    dot: "bg-[var(--status-away)]",
    text: "text-[var(--status-away)]",
    bg: "bg-[var(--status-away)]/10",
    ring: "ring-[var(--status-away)]/40",
    presence: "away",
  },
  invisible: {
    labelKey: "statusInvisible",
    icon: "eye-off",
    dot: "bg-[var(--status-invisible)]",
    text: "text-[var(--status-invisible)]",
    bg: "bg-[var(--status-invisible)]/10",
    ring: "ring-[var(--status-invisible)]/40",
    presence: "offline",
  },
};
...
export async function saveSettingsAsync(settings: Settings, profileId?: string, userIdOverride?: string): Promise<void> {
  ...
  try {
    ...
    const payload = {
      ...
      dynamic_island_visible: settings.dynamicIslandVisible ?? false,
