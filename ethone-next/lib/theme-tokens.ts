...
export const PRESET_THEMES: Record<PremiumThemeId, ThemeDefinition> = {
  ...
  forest: {
    ...
    description: "Ambiance organique et naturelle : vert émeraude profond, mousses et contrastes subtils.",
    category: "dark",
    colorScheme: "dark",
    bgMain: "#050f0a",
    bgSurface: "#0a1912",
    bgSurfaceElevated: "#12261c",
    bgSurfaceHover: "#1b3327",
    bgSidebar: "#07130e",
    bgCard: "#0d2017",
    bgInput: "rgba(16, 185, 129, 0.05)",
  ...
  sunset: {
    ...
    description: "Chaleur d'un crépuscule d'été : ambre radiant, cuivre incandescent et noir bistre.",
    category: "dark",
    colorScheme: "dark",
    bgMain: "#100806",
    bgSurface: "#1a0e0a",
    bgSurfaceElevated: "#281711",
    bgSurfaceHover: "#371f17",
    bgSidebar: "#130a07",
    bgCard: "#20120d",
    bgInput: "rgba(249, 115, 22, 0.05)",
    borderSubtle: "rgba(249, 115, 22, 0.14)",
  ...
  rose: {
    id: "rose",
    label: "Velvet Rose",
    description: "Élégance nocturne veloutée : rose rubis délicat, bordeaux profond et contrastes soyeux.",
    category: "dark",
    colorScheme: "dark",
    bgMain: "#12060a",
    bgSurface: "#1d0b12",
    bgSurfaceElevated: "#2a101b",
    bgSurfaceHover: "#3a1727",
    bgSidebar: "#16080d",
    bgCard: "#220d16",
    bgInput: "rgba(244, 63, 94, 0.05)",
    borderSubtle: "rgba(244, 63, 94, 0.14)",
    borderActive: "rgba(244, 63, 94, 0.45)",
    borderFocus: "#f43f5e",
    accentPrimary: "#f43f5e",
