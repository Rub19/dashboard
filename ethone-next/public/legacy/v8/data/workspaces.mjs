const WIDGETS = Object.freeze({
  ...
  tasks: Object.freeze({ id: "tasks", label: "Priorités", icon: "circle-check-big", actionId: "v8.tasks.open", countKey: "tasks" }),
...
export const WORKSPACES = Object.freeze([
  ...
  workspace({ id: "focus", label: "Focus", flow: "Deep Work", accent: "sky", actionId: "v8.space.focus", icon: "focus", description: "Un environnement calme pour avancer sur une priorité.", steps: ["Choisir", "Concentrer", "Terminer"], widgets: ["tasks", "calendar", "brain", "notes"] }),
