...
Content-Security-Policy: default-src 'self'; script-src 'self' https://cdn.jsdelivr.net https://unpkg.com; script-src-attr 'none'; style-src 'self' https://fonts.googleapis.com; style-src-attr 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: blob: https://i.scdn.co; connect-src 'self' https://bvgifyzhpzkbrwdjrqsg.supabase.co wss://bvgifyzhpzkbrwdjrqsg.supabase.co https://raspy-fog-bf5b.rub19-mailpro.workers.dev; media-src 'self' blob:; worker-src 'self'; manifest-src 'self'; object-src 'none'; base-uri 'self'; form-action 'self'; frame-src 'none'; upgrade-insecure-requests; frame-ancestors 'none'
```
