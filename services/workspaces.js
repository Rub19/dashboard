...
(function(){
  ...
  function applyVisual(w){
    if(!w)return;
    var root=document.documentElement,st=coreStorage(),accent=w.accent||"#8b5cf6",rgb=hexToRgb(accent),rgbValue=rgb.join(",");
    var hover=mix(accent,.22),active=mix(accent,-.12),hoverRgb=hexToRgb(hover).join(","),activeRgb=hexToRgb(active).join(",");
    ...
    root.style.setProperty("--primary-active-rgb",activeRgb);
    ...
    root.style.setProperty("--eh-accent-rgb",rgbValue);
    root.style.setProperty("--space-accent",accent);
    root.style.setProperty("--space-accent-rgb",rgbValue);
    root.style.setProperty("--accent-border","rgba("+rgbValue+",.32)");
    root.style.setProperty("--accent-subtle","rgba("+rgbValue+",.08)");
    root.style.setProperty("--accent-soft","rgba("+rgbValue+",.13)");
    root.style.setProperty("--accent-glow","rgba("+rgbValue+",.25)");
    root.style.setProperty("--accent-shadow","rgba("+rgbValue+",.22)");
    root.style.setProperty("--border3","rgba("+rgbValue+",.20)");
