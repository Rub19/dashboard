...
alter table public.user_provider_credentials add constraint user_provider_credentials_provider_check check (provider in ('steam', 'twitch', 'lastfm', 'henrik', 'tracker', 'riot'));
