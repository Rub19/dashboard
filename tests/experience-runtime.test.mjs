...
test("Typography tokens keep primary and secondary content readable", () => {
  ...
  assert.match(tokens, /--v8-font-xs:\s*max\(0\.78125rem,[^;]+--density-font-scale/);
  assert.match(tokens, /--v8-font-sm:\s*calc\(0\.84375rem \* var\(--density-font-scale\)\)/);
  assert.match(tokens, /--v8-font-micro:\s*max\(0\.6875rem,[^;]+--density-font-scale/);
