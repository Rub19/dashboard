...
(function(){
        ...
        if(tl) tl.style.cssText=base+';font-weight:600;background:transparent;color:#fff;box-shadow:none';
        if(tr) tr.style.cssText=base+';font-weight:500;background:transparent;color:rgba(250,250,249,.35)';
      })();
