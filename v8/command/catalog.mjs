const commands = [
  ...
  { id: "thème.toggle", actionId: "v8.thème.toggle", label: "Changer de thème", subtitle: "Basculer Nuit ou Graphite", category: "Réglages", icon: "sun-moon", keywords: ["thème", "nuit", "graphite", "apparence"], contexts: ["settings"], contextPriority: 100 },
