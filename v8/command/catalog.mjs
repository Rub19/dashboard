const rawCommands = [
  ...
  { id: "changelog.open", actionId: "v8.changelog.open", label: "Notes de version (Changelog)", subtitle: "Nouveautés et historique ETHONE v194", category: "Système", icon: "badge-check", keywords: ["changelog", "version", "mise à jour", "maj", "nouveautés", "notes"] },
