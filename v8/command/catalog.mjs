const commands = [
  ...
  { id: "density.automatic", actionId: "v8.density.automatic", label: "Densite automatique", subtitle: "Adapter l'interface a l'ecran et au contexte", category: "Reglages", icon: "wand-sparkles", keywords: ["densite", "automatique", "zoom", "responsive"], contexts: ["settings"], contextPriority: 102 },
  { id: "density.spacious", actionId: "v8.density.spacious", label: "Densite spacieuse", subtitle: "Lecture et cibles genereuses", category: "Reglages", icon: "maximize-2", keywords: ["densite", "spacieux", "accessibilite"], contexts: ["settings"], contextPriority: 96 },
  { id: "density.comfortable", actionId: "v8.density.comfortable", label: "Densite confortable", subtitle: "Equilibre ETHONE par defaut", category: "Reglages", icon: "panel-top", keywords: ["densite", "confortable", "interface"], contexts: ["settings"], contextPriority: 96 },
  { id: "density.compact", actionId: "v8.density.compact", label: "Densite compacte", subtitle: "Plus d'information visible", category: "Reglages", icon: "rows-3", keywords: ["densite", "compact", "interface"], contexts: ["settings"], contextPriority: 96 },
  { id: "density.ultra", actionId: "v8.density.ultra-compact", label: "Densite ultra compacte", subtitle: "Densite maximale, focus conserve", category: "Reglages", icon: "list-collapse", keywords: ["densite", "ultra", "compact"], contexts: ["settings"], contextPriority: 94 },
