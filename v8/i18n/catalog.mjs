...
const ENTRIES = {
  ...
  "Accent personnalise": { "fr": "Accent personnalisé", "en": "Custom accent", "es": "Acento personalizado", "de": "Individueller Akzent" },
  "Choisir une couleur d'accent personnalisee": { "fr": "Choisir une couleur d'accent personnalisée", "en": "Choose a custom accent color", "es": "Elegir un color de acento personalizado", "de": "Individuelle Akzentfarbe wählen" },
  "Couleur personnalisee": { "fr": "Couleur personnalisée", "en": "Custom color", "es": "Color personalizado", "de": "Individuelle Farbe" },
