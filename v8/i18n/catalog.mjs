...
const ENTRIES = {
  ...
  "Continuite numérique": { "fr": "Continuité numérique", "en": "Digital continuity", "es": "Continuidad digital", "de": "Digitale Kontinuität" },
  "Tout ce qui compte dans votre ecosysteme, regroupé sans bruit.": { "fr": "Tout ce qui compte dans votre écosystème, regroupé sans bruit.", "en": "Everything that matters in your ecosystem, gathered without noise.", "es": "Todo lo importante de tu ecosistema, reunido sin ruido.", "de": "Alles Wichtige aus Ihrem Ökosystem, ruhig zusammengeführt." },
  ...
  "Aucun secret d'intégration n'est conserve dans le navigateur.": { "fr": "Aucun secret d'intégration n'est conservé dans le navigateur.", "en": "No integration secret is stored in the browser.", "es": "No se guarda ningún secreto de integración en el navegador.", "de": "Keine Integrationsgeheimnisse werden im Browser gespeichert." },
  ...
  "Données maitrisees": { "fr": "Données maîtrisées", "en": "Data under control", "es": "Datos bajo control", "de": "Kontrollierte Daten" },
