...
const OPERATIONS = Object.freeze({
  ...
  trackerApexProfile: Object.freeze({ path: "/api/stats/apex-profile", auth: true, params: ["platform", "identifier"] }),
  trackerValorantProfile: Object.freeze({ path: "/api/stats/valorant-profile", auth: true, params: ["name", "tag"] }),
  trackerLolProfile: Object.freeze({ path: "/api/stats/lol-profile", auth: true, params: ["name", "tag"] }),
  trackerApexMatches: Object.freeze({ path: "/api/stats/apex-matches", auth: true, params: ["platform", "identifier", "mode"] }),
  trackerValorantMatches: Object.freeze({ path: "/api/stats/valorant-matches", auth: true, params: ["name", "tag", "mode"] }),
  trackerLolMatches: Object.freeze({ path: "/api/stats/lol-matches", auth: true, params: ["name", "tag", "mode"] }),
