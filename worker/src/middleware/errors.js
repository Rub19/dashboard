const PUBLIC_MESSAGES = Object.freeze({
  ...
  SPACE_NOT_FOUND: "Cet espace n'existe pas ou vous n'y avez pas acces.",
  SPACE_INVITE_INVALID: "Cette invitation n'est plus valide.",
  SPACE_INVITE_EXPIRED: "Cette invitation a expire. Demandez-en une nouvelle.",
  SPACE_INVITE_EMAIL_MISMATCH: "Cette invitation a ete envoyee a une autre adresse e-mail.",
