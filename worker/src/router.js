...
export const ROUTES = Object.freeze([
  ...
  route("spotify.now-playing", "/api/spotify/now-playing", spotifyNowPlayingRoute, { public: true, service: "spotify", rateLimit: "edge" }),
  route("spotify.control", "/api/spotify/control", spotifyControlRoute, { method: "POST", service: "spotify", rateLimit: "strict" }),
  route("spotify.track-saved", "/api/spotify/track-saved", spotifyTrackSavedRoute, { public: true, service: "spotify", rateLimit: "edge" }),
