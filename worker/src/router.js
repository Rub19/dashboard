...
export const ROUTES = Object.freeze([
  ...
  route("tracker.apex-profile", "/api/stats/apex-profile", trackerRoute, { service: "tracker" }),
  route("tracker.valorant-profile", "/api/stats/valorant-profile", trackerValorantRoute, { service: "tracker" }),
  route("tracker.lol-profile", "/api/stats/lol-profile", trackerLolRoute, { service: "tracker" }),
  route("tracker.apex-matches", "/api/stats/apex-matches", trackerApexMatchesRoute, { service: "tracker" }),
  route("tracker.valorant-matches", "/api/stats/valorant-matches", trackerValorantMatchesRoute, { service: "tracker" }),
  route("tracker.lol-matches", "/api/stats/lol-matches", trackerLolMatchesRoute, { service: "tracker" }),
