...
export const ROUTES = Object.freeze([
  ...
  route("tracker.apex-profile", "/api/stats/apex-profile", trackerRoute, { service: "tracker", rateLimit: "standard" }),
  route("tracker.valorant-profile", "/api/stats/valorant-profile", trackerValorantRoute, { service: "tracker", rateLimit: "standard" }),
  route("tracker.lol-profile", "/api/stats/lol-profile", trackerLolRoute, { service: "tracker", rateLimit: "standard" }),
  route("tracker.apex-matches", "/api/stats/apex-matches", trackerApexMatchesRoute, { service: "tracker", rateLimit: "standard" }),
  route("tracker.valorant-matches", "/api/stats/valorant-matches", trackerValorantMatchesRoute, { service: "tracker", rateLimit: "standard" }),
  route("tracker.lol-matches", "/api/stats/lol-matches", trackerLolMatchesRoute, { service: "tracker", rateLimit: "standard" }),
