...
export const ROUTES = Object.freeze([
  ...
  route("health.api", "/api/health", healthRoute, { public: true, rateLimit: "edge" }),
  route("diagnostic", "/api/diagnostic", diagnosticRoute, { rateLimit: "strict" }),
  route("rss.feed", "/api/rss", rssRoute, { public: true, service: "rss", rateLimit: "edge" }),
  ...
  route("steam.player", "/api/steam/player", steamRoute, { public: true, service: "steam", action: "player", rateLimit: "edge" }),
  route("steam.recent-games", "/api/steam/recent-games", steamRoute, { public: true, service: "steam", action: "recent-games", rateLimit: "edge" }),
  route("steam.owned-games", "/api/steam/owned-games", steamRoute, { public: true, service: "steam", action: "owned-games", rateLimit: "edge" }),
  route("steam.achievements", "/api/steam/achievements", steamRoute, { public: true, service: "steam", action: "achievements", rateLimit: "edge" }),
  route("tracker.apex-profile", "/api/stats/apex-profile", trackerRoute, { public: true, service: "tracker", rateLimit: "edge" }),
  route("tracker.valorant-profile", "/api/stats/valorant-profile", trackerValorantRoute, { public: true, service: "tracker", rateLimit: "edge" }),
  ...
  route("catalog.profile", "/api/catalog/profile", catalogProfileRoute, { public: true, service: "catalog", rateLimit: "edge" }),
  route("supabase.public-profile", "/api/supabase/public-profile", supabaseRoute, { public: true, service: "supabase", rateLimit: "edge" }),
  route("weather.forecast", "/api/weather", weatherRoute, { public: true, service: "weather", rateLimit: "edge" }),
  route("weather.geocode", "/api/geocode", geocodeRoute, { public: true, service: "weather", rateLimit: "edge" }),
  route("bills.scan", "/api/bills/scan", billsScanRoute, { method: "POST", service: "bills", rateLimit: "strict" }),
  route("rss", "/api/rss", rssRoute, { public: true, service: "rss", rateLimit: "edge" }),
  route("minecraft.profile", "/api/minecraft/profile", minecraftRoute, { public: true, service: "minecraft", rateLimit: "edge" }),
  ...
  route("spotify.now-playing", "/api/spotify/now-playing", spotifyNowPlayingRoute, { service: "spotify", rateLimit: "edge" }),
  route("spotify.control", "/api/spotify/control", spotifyControlRoute, { method: "POST", service: "spotify", rateLimit: "strict" }),
  route("spotify.track-saved", "/api/spotify/track-saved", spotifyTrackSavedRoute, { service: "spotify", rateLimit: "edge" }),
  ...
  route("shared-spaces.members.delete", "/api/shared-spaces/members", sharedSpaceMembersRoute, { method: "DELETE", service: "shared-spaces", rateLimit: "strict" }),
  ...
  route("connections.disconnect", "/api/connections/disconnect", connectionsDisconnectRoute, { method: "POST", service: "sync", rateLimit: "standard" }),
