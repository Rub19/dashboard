...
const ROUTE_CASES = Object.freeze([
  ...
  ["Tracker LoL matches", "/api/tracker/lol-matches?name=Player&tag=EUW&mode=all", (data) => data.length === 1 && data[0].metadata.agentName === "Ahri" && data[0].scoreboard.players[0].isMe === true],
